// July 11, 2018 - VL modified original Ciconia Studio/Effects/Skin -- add ability for 2nd MainText blend

Shader "Custom/SkinBlend" {
    Properties {
        [Space(15)][Header(Main Properties)]
        [Space(15)]_Color ("Color", Color) = (1,1,1,1)
        _MainTex ("Albedo", 2D) = "white" {}
        _MainTex2 ("Albedo 2 (RGB)", 2D) = "white" {}
        //_SkinTextureBlend ("Texture Blend", Range(0,1)) = 0.0  --> for setting blend mt at runtime-- set using Shader.SetGlobalFloat 
    ...
    SubShader {
        ...
        Pass {
            ...
            uniform half _SkinTextureBlend;
...
/////// Diffuse:
                ...
                float4 mainTex_blend = lerp(_MainTex_var, _MainTex2_var, _SkinTextureBlend);

                float3 Diffusemap = (_Color.rgb*mainTex_blend.rgb);
